...
<body>
    ...
    <div class="site-wrapper">
        ...
        <section class="container-fluid py-5" id="book-appointment">
            <div class="container px-5 text-center text-light d-flex flex-column align-items-center">
        ...
        <section id="faq" class="py-5 container-fluid">
            <div class="container py-5">
        ...
        <section id="get-in-touch" class="py-5 container-fluid">
            <div class="container py-5">
                <div class="row justify-content-center align-items-center">
                    ...
                    <div class="col-lg-6">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d248.15577710538773!2d-0.07300639880290646!3d5.641651344222471!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf86aa3a1ebb31%3A0x19cefeaef2f74c0a!2s56%20Ezra%20Rd!5e0!3m2!1sfr!2sgh!4v1669477118297!5m2!1sfr!2sgh" class="w-100" style="border:0;height:25rem;" loading="lazy"></iframe>
                    </div>
                </div>
            </div>
        </section>

        <section class="footer py-5 container-fluid text-light">
                ...
                <div class="row justify-content-center align-items-center align-items-lg-start pb-3">
                    ...
                    <div class="col-12 col-md-3 text-center text-md-start py-3">
                        ...
                        <ul class="p-0">
                            ...
                            <li class="d-block mb-3">
                                <a href="mailto:info@uzimahomes.com" target="_blank" title="mailto:info@uzimahomes.com" class="text-light text-decoration-none">
                                    <i class="bi bi-envelope global-color-accent"></i>
                                    <span>info@uzimahomes.com</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="col-12 col-md-3 text-center text-md-start py-3">
                        <p class="fw-bold h3">Quick links</p>
                        <ul class="p-0">
                            <li class="d-block mb-3">
                                <a href="" title="Home" class="text-light text-decoration-none">
                                    <span>Home</span>
                                </a>
                            </li>
                            <li class="d-block mb-3">
                    ...
                    <div class="col-12 col-md-3 text-center text-md-start py-3">
                        <p class="fw-bold h3">Location</p>
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d248.15577710538773!2d-0.07300639880290646!3d5.641651344222471!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf86aa3a1ebb31%3A0x19cefeaef2f74c0a!2s56%20Ezra%20Rd!5e0!3m2!1sfr!2sgh!4v1669477118297!5m2!1sfr!2sgh" class="w-100" style="border:0;" loading="lazy"></iframe>
                    </div>
                </div>
                <p class="text-center fs-12px">
                    This website is the sole property of <span class="fw-bold">UZIMA HOMES</span>. <br>
                    All Rights Reserved
                </p>
                <p class="text-center fs-12px">Designed and developed by Oswald Houndekon</p>
            </div>
        </section>
    </div>
